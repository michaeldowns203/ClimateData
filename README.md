This program analyzes climate data CSV files and prints the highest and lowest temperature anomoly, sea level rise, and average co2 concentration (from each respective file). 
